...
from .views import TestBaseView, WeatherIndexView, PlaceListView, PlaceCreateView, place_detail_view, place_update_view, AboutView, place_delete_view, weather_forecast_test_view
