...
from .views import TestBaseView, WeatherIndexView, PlaceListView, PlaceCreateView, PlaceDetailView, place_update_view, AboutView, place_delete_view, weather_forecast_test_view
